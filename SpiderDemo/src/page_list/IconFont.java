...
/**
 * 
 * 类名称：IconFont 类描述： 获取阿里巴巴 创建人：geekfly 创建时间：2017年8月14日 下午7:48:16
 * 
 * @version V1.0
 *
 */
public class IconFont {
	...
	public static void main(String[] args) throws IOException {
		...
		while (true) {
			...
			/*
			 * 返回数据类似以下格式 { "code":200 "data:{ "counts":103, "icons":{
			...
			if (icons.isEmpty()) {
				System.out.println("结束，共计：" + data_key.get("count")); // {data={"count":103,"icons":[]},
																		// code=200}
				break;
			} else {
	...
	public static String Post(String url, Integer page_number) {
		try {
			...
			params.add(new BasicNameValuePair("t", String.valueOf(new Date().getTime()))); // 当前时间戳
																							// 1502713082550
