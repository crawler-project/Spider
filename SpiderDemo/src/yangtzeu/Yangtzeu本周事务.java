...
/**
 * TODO 长江大学教务处 >> 教务新闻 >> 本周事务(http://jwc.yangtzeu.edu.cn/jwnews/jwxw/bzsw/index.html)
 * 这里只获取了第一页的数据
 * 获取方法和获取教务通知的方法一样
 * @author 寇爽
 ...
 * @version 1.8
 */
public class Yangtzeu本周事务 {

	public static void main(String[] args) throws IOException {
		String url = "http://jwc.yangtzeu.edu.cn/jwnews/jwxw/bzsw/index.html";
